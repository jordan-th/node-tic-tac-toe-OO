...
class Board {
  ...
  display() {
    ...
    console.log("     |     |"); // We dont have to access .marker directly because interpolation uses .toString();
    console.log("-----+-----+-----");
    console.log("     |     |");
...
class TTTGame {
  ...
  computerMoves() {
    let validChoices = this.board.unusedSquares();
    let randomIdx = Math.floor(validChoices.length * Math.random());
    let choice = validChoices[randomIdx];
